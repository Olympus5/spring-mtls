...
keytool -importcert -file ./ca.olympus5.org.crt -keystore ./../mtls-server/src/main/resources/server-trustore.jks -storetype JKS -storepass azerty -alias ca.olympus5.org -noprompt